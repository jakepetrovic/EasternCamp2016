...
# Now search through all the child directories of this directory and find the MP3 files.
   ...
   for file in files:
       ...
       if file.endswith(".mp3"):
        ...
        if event == '1':
           ...
           else album = "Children's Choirs & Orchestra"   
        ...
        # Track numbers are not included in the title name, and thus we don't wory about them for forums. 
            ...
            day = get_day(day_num)	 
            album = "Forums"
        else print "File "+ audioFileName + " named incorrectly. Does not start with a number between 1 and 4. Skipping to next file."
